...
abstract class AbstractProjectTask extends DefaultTask {
    ...
    static final String NEW_PACKAGE_NAME = 'newPackage'
    ...
    protected String projectName(){
        project.properties[NEW_PROJECT_NAME] ?: TemplatesPlugin.prompt('Project Name:',"demo")
    }
    ...
    protected String projectPath( final String projectName ){
        ...
        if( parentDir ){
            ...
            String dir = TemplatesPlugin.prompt( 'Root Project Name:',"")
            return dir == "" ? "$projectName":"$dir/$projectName"
        }
    }
